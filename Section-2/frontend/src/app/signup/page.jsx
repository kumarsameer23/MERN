...
import 'ldrs/react/DotWave.css'
 ...
 const SignupSchema = Yup.object().shape({
   ...
   name: Yup.string()
     .min(2, 'Too Short!')
     .max(50, 'Too Long!')
     .required('Naam likh do babu (-_-)'),

   email: Yup.string().email('Invalid email').required('Email galat likhe ho babua (-_-)'),
              ...
              <div className="grid gap-y-4">
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    />
                    <button className="text-white" type="button" onClick={() => {setPasswordHidden(!passwordHidden)}}>Toggle visibility</button>
                    <div className="hidden absolute inset-y-0 end-0 pointer-events-none pe-3">
                      <svg
                        className="size-5 text-red-500"
                        width="16"
